...
See the class [MyApiResource.java](server/src/main/java/cz/muni/pa165/generated/server/MyApiResource.java)
...
**server/target/generated-sources/jaxrs/cz/muni/pa165/generated/server/**.
...
run by issuing the command `mvn test`.
...
./mvnw quarkus:dev
```
then visit the Swagger UI for the service at http://localhost:8080/q/swas`gger-ui and call the hello
